            ...
            <div class="relative min-h-screen flex flex-col items-center justify-center">
                <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                    ...
                    <main class="mt-6">
                        ...
                        <div class="mb-8">
                            <h2 class="text-2xl font-semibold text-black dark:text-white mb-4">Popular Marketplaces</h2>
                            <div class="grid grid-cols-2 md:grid-cols-4 gap-6">
                                @foreach($marketplaces as $marketplace)
                                <a href="{{ $marketplace->url }}" 
                                   class="flex items-center p-4 bg-white dark:bg-zinc-900 rounded-lg shadow-lg hover:ring-2 hover:ring-[#FF2D20] transition">
                                    <img src="{{ $marketplace->logo }}" alt="{{ $marketplace->name }}" class="w-8 h-8 mr-3">
                                    <span class="text-black dark:text-white font-semibold">{{ $marketplace->name }}</span>
                                </a>
                                @endforeach
                            </div>
                        </div>
                    ...
                    <footer class="py-16 text-center text-sm text-black dark:text-white/70">
                        <p>Find the best deals across multiple marketplaces</p>
                    </footer>
                </div>
            </div>
        </div>
